...
export function App({ initialTourId, replyAgent }: AppProps): React.JSX.Element {
  ...
  // of PRD #278 lifts it into the runtime). Every other intent the reducer
  // emits (loadTour, submitAnnotation, scroll / mirror / reveal /
  // scrollToAnnotation) is realised by the Tour-session runtime via the
  // adapter (slices 2-6).
  useEffect(() => {
