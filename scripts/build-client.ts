...
// Empty stubs + EMBEDDED_BUILD_MODE = "dev" are committed at
// src/web/embedded-client.ts — the binary build pipeline overwrites this
// file with the real bundle strings AND flips EMBEDDED_BUILD_MODE to
...
// regardless of the bundle strings' content (issue #204).
